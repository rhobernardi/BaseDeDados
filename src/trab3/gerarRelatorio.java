...
final class gerarRelatorio extends javax.swing.JFrame {
    ...
    public gerarRelatorio(String host, String user, String pass, Connection con, int type) {
        this.host = host;
        this.user = user;
        this.pass = pass;
        this.con = con;
